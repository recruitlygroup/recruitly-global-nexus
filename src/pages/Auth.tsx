        ...
        <div className="backdrop-blur-xl bg-white/10 rounded-3xl p-8 shadow-2xl border border-white/20">
          ...
          <div className="flex bg-white/5 rounded-2xl p-1.5 mb-8">
            <button
              ...
              className={`flex-1 flex items-center justify-center gap-2 py-3 px-4 rounded-xl text-sm font-medium transition-all duration-300 ${
                role === "student"
                  ? "bg-[#fbbf24] text-[#0a192f] shadow-lg shadow-[#fbbf24]/30"
              ...
              {role === "student" && (
                <div className="space-y-3 mb-6">
                  <Button
                    ...
                    disabled={isLoading}
                    className="w-full bg-white hover:bg-gray-100 text-gray-800 font-medium py-6 rounded-xl flex items-center justify-center gap-3 transition-all duration-300 hover:shadow-lg"
                  >
                  ...
                  <Button
                    ...
                    disabled={isLoading}
                    className="w-full bg-[#25D366] hover:bg-[#20BD5A] text-white font-medium py-6 rounded-xl flex items-center justify-center gap-3 transition-all duration-300 hover:shadow-lg hover:shadow-[#25D366]/30"
                  >
              ...
              <form onSubmit={handleEmailLogin} className="space-y-4">
                ...
                <div className="flex gap-3 pt-2">
                  <Button
                    type="submit"
                    disabled={isLoading}
                    className="flex-1 bg-[#fbbf24] hover:bg-[#f59e0b] text-[#0a192f] font-semibold py-6 rounded-xl transition-all duration-300 hover:shadow-lg hover:shadow-[#fbbf24]/30"
                  >
                  ...
                  <Button
                    ...
                    disabled={isLoading}
                    variant="outline"
                    className="flex-1 border-white/20 text-white hover:bg-white/10 py-6 rounded-xl transition-all duration-300"
                  >
                    {isLoading ? "..." : "Sign Up"}
                  </Button>
                </div>
          ...
          <div className="mt-8 pt-6 border-t border-white/10 text-center">
            ...
            >
              ...
              Need help? Talk to Khem on WhatsApp
            </a>
          </div>
        </div>
