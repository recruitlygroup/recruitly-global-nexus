...
type TabId = "overview" | "admission" | "universities" | "profile";
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              <Card>
                <CardContent className="p-4">
                  ...
                  <p className={`text-2xl font-bold ${scoreColor(wiseScore?.visa_score ?? null)}`}>
                    {wiseScore?.visa_score ? `${wiseScore.visa_score}%` : "Not predicted"}
                  </p>
                </CardContent>
              </Card>
              <Card>
            ...
            {!wiseScore && (
              <Card className="border-dashed">
                <CardContent className="p-8 text-center">
                  ...
                  <Button asChild>
                    <Link to="/educational-consultancy">
                      Check My WiseScore <ArrowRight className="w-4 h-4 ml-2" />
                    </Link>
                  </Button>
                </CardContent>
              </Card>
              ...
              <Card>
                <CardContent className="p-6">
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <Link to="/educational-consultancy" className="text-sm text-primary hover:underline">
                      Retake WiseScore →
                    </Link>
                  </div>
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                    <div>
                      ...
                      <p className="font-medium">{wiseScore.target_country || "—"}</p>
                    </div>
                    <div>
                      <span className="text-muted-foreground">Level</span>
                      <p className="font-medium">{wiseScore.study_level || "—"}</p>
                    </div>
                    <div>
                      <span className="text-muted-foreground">Field</span>
                      <p className="font-medium">{wiseScore.field || "—"}</p>
                    </div>
                    <div>
                      <span className="text-muted-foreground">Last Updated</span>
                      <p className="font-medium">{new Date(wiseScore.created_at).toLocaleDateString()}</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
            ...
            {!wiseScore ? (
              <Card className="border-dashed">
                <CardContent className="p-8 text-center">
                  ...
                  <Button asChild>
                    <Link to="/educational-consultancy">Take WiseScore <ArrowRight className="w-4 h-4 ml-2" /></Link>
                  </Button>
                </CardContent>
              </Card>
            ) : (
          ...
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="space-y-6">
            <div className="flex items-center justify-between">
              ...
              <Button variant="outline" size="sm" asChild>
                <Link to="/universities">Browse All →</Link>
              </Button>
            </div>
            ...
            {wiseScore?.target_country ? (
              ...
              <Card className="border-dashed">
                <CardContent className="p-8 text-center">
                  ...
                  <Button asChild>
                    <Link to="/educational-consultancy">Check My WiseScore</Link>
                  </Button>
                </CardContent>
              </Card>
            )}
