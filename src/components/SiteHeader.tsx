...
import { GraduationCap, Briefcase, FileCheck, Plane, Menu, X, BookOpen, MessageCircle } from "lucide-react";
...
const SiteHeader = () => {
  ...
  const navItems = [
    { label: "Work Abroad", icon: Briefcase, path: "/work-abroad" },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          >
            ...
            <span className="text-lg font-bold text-foreground hidden sm:block">Recruitly Group</span>
          </motion.button>
          ...
          <div className="hidden md:flex items-center gap-2">
            <Button
              onClick={() => window.open("https://wa.me/9779743208282", "_blank")}
        ...
        {isMobileMenuOpen && (
          ...
          >
            <nav className="flex flex-col gap-2">
              ...
              <Button
                onClick={() => { window.open("https://wa.me/9779743208282", "_blank"); setIsMobileMenuOpen(false); }}
                className="mt-2 bg-[#25D366] hover:bg-[#20BD5A] text-white gap-2"
              >
                <MessageCircle className="w-4 h-4" />
                WhatsApp Us
              </Button>
